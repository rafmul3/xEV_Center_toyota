    ...
    @section('content')
        ...
        <div class="inner-content-tabbing-visitordetail my-3 py-3">
            <div class="mx-3 mb-3">
                ...
                <form action="/setting/reservationSession/update" method="post">
                <div class="col-md-12 mt-5">
                    <div class="card" style="background-color: #C3C3C3;">
                            @csrf
                            <input type="hidden" name="id" value={{ $reservationSession->id }}>
                            <div class="card-body mt-2 mx-3">
                                <h3>Session Name <i class="fa-solid fa-star-of-life fa-2xs" style="color: #FF0000;"></i></h3>
                            </div>
                            <div class="card-body mx-2">
                                <input type="text" name="session_name" class="form-control" required placeholder="Masukkan Nama Sesi Misal : Sesi 1" aria-label="Username" aria-describedby="addon-wrapping" value="{{ $reservationSession->session_name }}">
                            </div>
                            <div class="card-body mt-2 mx-3">
                            ...
                            <div class="input-group flex-nowrap mt-2 mx-4 mb-2">
                                ...
                                <input type="text" name="start_time" class="form-control" required style="margin-right: 50px;" placeholder="09:00 AM" aria-label="Username" aria-describedby="addon-wrapping" value={{ $reservationSession->start_time }}>
                            </div>
                            <div class="card-body mt-2 mx-3">
                            ...
                            <div class="input-group flex-nowrap mt-2 mx-4 mb-2">
                                <span class="input-group-text" style="font-weight: bold;" id="addon-wrapping">X</span>
                                <input type="text" name="end_time" class="form-control" required style="margin-right: 50px;" placeholder="11:00 AM" aria-label="Username" aria-describedby="addon-wrapping" value={{ $reservationSession->end_time }}>
                            </div>
