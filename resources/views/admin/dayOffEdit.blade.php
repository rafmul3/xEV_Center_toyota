    ...
    @section('content')
        ...
        <div class="inner-content-tabbing-visitordetail my-3 py-3">
            <div class="mx-3 mb-3">
                ...
                <form action="/setting/dayOff/Update" method="post">
                    @csrf
                    ...
                    <div class="card" style="background-color: #C3C3C3;">
                        <input type=hidden name="id" value={{ $dayOff->id }}/> 
                            ...
                            <div class="input-group flex-nowrap mt-2 mx-4 mb-2">
                                ...
                                <input id="tanggal" readonly="readonly" name="date" value="{{$dayOff->date}}" class="form-control" style="margin-right: 50px;" placeholder="YYYY/MM/DD" aria-label="Username" aria-describedby="addon-wrapping" required> 
                            </div>
                            <div class="card-body mt-2 mx-3">
                                <h3>Status Day <i class="fa-solid fa-star-of-life fa-2xs" style="color: #FF0000;"></i></h3>
                            </div>
                            <div class="card-body mx-2">
                                <input type="text" name="status_day" value="{{ $dayOff->status_day }}" class="form-control" placeholder="Masukkan Status Misal : Hari Kemerdekaan" aria-label="Username" aria-describedby="addon-wrapping">
                            </div>
                            <div class="px-4 mb-3 mt-3">
                                ...
                                <button class="btn btn-primary flex-center px-4 mx-2 border-radius-8 btn-sm" type="submit" id="submit-reservation" style="background-color: #00CE2D; color: white; font-weight: bold; float: right;">Update</button>
                            </div>
                    </div>
                </div>
                </form>
